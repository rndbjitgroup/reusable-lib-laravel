...
class SampleController extends BaseController
{
    ...
    public function index(SampleFilterRequest $request): JsonResponse
    {
    ...
    public function list(SampleFilterRequest $request): JsonResponse
    {
    ...
    public function showCommon(Sample $sample): JsonResponse
    {
    ...
    public function update(SampleUpdateRequest $request, Sample $sample): JsonResponse
    {
