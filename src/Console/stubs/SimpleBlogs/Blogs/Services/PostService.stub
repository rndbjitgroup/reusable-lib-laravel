...
class PostService 
{
    ...
    protected function uploadImageWithResize($file, $paramFileName = null, $post = null)
    {
        ...
        if($file) {  
            ...
            $rtrData['thumbnail_path'] = config('constants.path.posts.thumbnails') . '/' . $uniqueName;
            ...
            $rtrData['image_path'] = config('constants.path.posts.normals') . '/' . $uniqueName;
            $file->move($destinationPath, $rtrData['image_path']);
        }
    ...
    public function store($request)
    {
        ...
        $request->merge([
            ...
            'thumbnail_path' => $data['thumbnail_path'] ? $data['thumbnail_path'] : null 
        ]); 
